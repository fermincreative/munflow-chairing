...
function showRollCall() {
  ...
  if (committee_members[key]["present"]==false) {
    if (committee_members[key]["flag"]) {
    $('#rollcall-list').append("<div id=\"country-"+ key +"\" class=\"row rollcall-country\"><div class=\"col-8\"><div class=\"rollcall-flag\"><img src=\"/munflow-chairing"+committee_members[key]["flag"]+"\" alt=\"" +committee_members[key]["name"]+ "\"/></div>"+committee_members[key]["name"]+"</div><div class=\"col-4\"><button class=\"rollcall-standard rollcall-absent rollcall-filled\">Absent</button><button class=\"rollcall-standard rollcall-present\" onclick=\"markPresent("+key+",'absent')\">Present</button><button class=\"rollcall-standard rollcall-pv\" onclick=\"markPresentVoting("+key+",'absent')\">Present & Voting</button></div></div>");
    } else {
    ...
    if (committee_members[key]["flag"]) {
    $('#rollcall-list').append("<div id=\"country-"+ key +"\" class=\"row rollcall-country\"><div class=\"col-8\"><div class=\"rollcall-flag\"><img src=\"/munflow-chairing"+committee_members[key]["flag"]+"\" alt=\"" +committee_members[key]["name"]+ "\"/></div>"+committee_members[key]["name"]+"</div><div class=\"col-4\"><button class=\"rollcall-standard rollcall-absent\" onclick=\"markAbsent("+key+",'present')\">Absent</button><button class=\"rollcall-standard rollcall-present rollcall-filled\">Present</button><button class=\"rollcall-standard rollcall-pv\" onclick=\"markPresentVoting("+key+",'present')\">Present & Voting</button></div></div>");
    } else {
